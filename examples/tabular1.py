#tps may22 based on https://www.kaggle.com/code/ambrosm/tpsmay22-advanced-keras
...
from tensorflow.python.keras.layers import Dense, Input, InputLayer, Add, Concatenate
...
#Create three ternary categorical features which indicate in which region a sample is.
#The following diagrams show the three projections which lead to three regions each:
